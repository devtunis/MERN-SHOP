...
const LunetteForm = () => {
  ...
  const generateId = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post('/postLunette', data, {
            headers: {
  ...
  return (
    ...
    <h1>Upload Lunette  <p style={{fontSize:"10px",color:"red"}}>Size pictuer 1 mb to 8mb max</p></h1>
